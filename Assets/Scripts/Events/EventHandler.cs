...
public static class EventHandler
{
    ...
    public static void CallMovementEvent(
        ...
        bool isUsingToolRight = false,
        bool isUsingToolLeft = false,
        bool isUsingToolUp = false,
        bool isUsingToolDown = false,
        bool isLiftingToolRight = false,
        bool isLiftingToolLeft = false,
        bool isLiftingToolUp = false,
        bool isLiftingToolDown = false,
        bool isPickingRight = false,
        bool isPickingLeft = false,
        bool isPickingUp = false,
        bool isPickingDown = false,
        bool isSwingingToolRight = false,
        bool isSwingingToolLeft = false,
        bool isSwingingToolUp = false,
        bool isSwingingToolDown = false,
